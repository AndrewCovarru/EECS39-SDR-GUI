...
public class homeScreen extends JFrame {
	...
	public homeScreen() {
		...
		JLabel lblDeviceIndex = new JLabel("Device Index:");
		lblDeviceIndex.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 11));
		lblDeviceIndex.setForeground(Color.WHITE);
		lblDeviceIndex.setLabelFor(ipDisplay);
		lblDeviceIndex.setHorizontalAlignment(SwingConstants.LEFT);
		
		JFormattedTextField deviceIndexDisplay = new JFormattedTextField();
		deviceIndexDisplay.setEditable(false);
		lblDeviceIndex.setLabelFor(deviceIndexDisplay);
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_contentPane.createSequentialGroup()
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									.addGroup(gl_contentPane.createSequentialGroup()
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
											.addComponent(lblDeviceIndex)
											.addComponent(lblIPA)
											.addComponent(lblOversampling)
											.addComponent(lblScannableFrequency))
										.addPreferredGap(ComponentPlacement.UNRELATED)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
											.addComponent(deviceIndexDisplay)
											.addComponent(ipDisplay, GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)
											.addComponent(oversamplingDisplay, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)
											.addComponent(resampleDisplay)
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
							...
							.addGroup(gl_contentPane.createSequentialGroup()
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
									...
									.addComponent(lblEnableOption, Alignment.TRAILING)
									.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createSequentialGroup()
									...
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
											.addComponent(deviceIndexDisplay, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
											.addComponent(lblFirsize))
										.addComponent(lblDeviceIndex))))
							.addGap(39)
