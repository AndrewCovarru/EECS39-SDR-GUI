		...
		gl_contentPanel.setHorizontalGroup(
			gl_contentPanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_contentPanel.createSequentialGroup()
									.addContainerGap()
									.addComponent(num7, GroupLayout.DEFAULT_SIZE, 51, Short.MAX_VALUE)
									.addGap(70))
								.addGroup(gl_contentPanel.createSequentialGroup()
									.addComponent(num4)
									.addPreferredGap(ComponentPlacement.RELATED)
					...
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(num9, GroupLayout.PREFERRED_SIZE, 65, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
				...
				.addGroup(Alignment.TRAILING, gl_contentPanel.createSequentialGroup()
					...
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addGap(37)
							.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
								.addComponent(num9, GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
								.addComponent(btnBack, GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)))
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(num8, GroupLayout.PREFERRED_SIZE, 36, GroupLayout.PREFERRED_SIZE))))
		);
